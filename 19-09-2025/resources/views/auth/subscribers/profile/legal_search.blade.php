...
<div class="container form-container">
    <form method="POST" action="{{ route('subscriber.searchResult') }}">
        ...
        <div class="row g-3 form-group-row">
            ...
            <!-- <div class="col-md-4 mb-3">
                <label for="petitioners" class="form-label">Petitioner</label>
                <input type="text" class="form-control" id="petitioners" name="petitioners" placeholder="Petitioner" value="{{ old('petitioners', $inputs['petitioners'] ?? '') }}">
            </div>

            <div class="col-md-4 mb-3">
                <label for="respondent" class="form-label">Respondent</label>
                <input type="text" class="form-control" id="respondent" name="respondent" placeholder="Respondent" value="{{ old('respondent', $inputs['respondent'] ?? '') }}">
            </div> -->
