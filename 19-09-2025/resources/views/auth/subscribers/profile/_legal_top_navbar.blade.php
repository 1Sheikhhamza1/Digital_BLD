    ...
    <div class="top-action-bar mb-3">
        <div class="row align-items-center w-100 g-2">
            ...
            <div class="col-md-1 col-12 text-start mb-2 mb-md-0" style="z-index: 100;">
                @if(!$myDecision)
                <a href="{{ url('subscriber/'.$returnParamStirng) }}" class="action-link">
            ...
            <div class="col-md-2 col-12 justify-content-end nav-arrows mt-2 mt-md-0 d-flex justify-content-between">
                @if($previousDecision)
                <a href="{{ route('subscriber.singleDecision', [$previousDecision->id, Crypt::encrypt($returnParamStirng)]) }}" class="action-link me-2">
                ...
                @if($nextDecision)
                <a href="{{ route('subscriber.singleDecision', [$nextDecision->id, Crypt::encrypt($returnParamStirng)]) }}" class="action-link">
