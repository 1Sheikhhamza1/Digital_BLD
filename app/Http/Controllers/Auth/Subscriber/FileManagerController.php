...
class FileManagerController extends BaseController
{
    ...
    public function deleteSharedDecision($id)
    {
        $share = DecisionShare::where('id', $id)
            ->where('receiver_id', $this->subscriberId)
            ->firstOrFail();

        $share->delete();

        return back()->with('success', 'Shared decision deleted successfully.');
    }
