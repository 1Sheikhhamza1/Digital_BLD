                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="{{ route('subscriptions.index') }}" class="btn btn-primary btn-sm">Subscription List</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="app-content">
            <div class="form-container col-sm-8 offset-2">
                ...
                <form method="POST" action="{{ route('subscriptions.update', $subscription->id)  }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    @include('admin.subscriptions._form', ['buttonText' => 'Update'])
                </form>
            </div>
        </div>
    </main>
