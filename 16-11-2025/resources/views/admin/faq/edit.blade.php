                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6 mt-4">
                                            ...
                                            <input id="topic" type="text" class="form-control" name="topic" value="{{ $faq->topic }}" required>
                                            @if ($errors->has('topic'))
                                        ...
                                        <div class="col-sm-6 mt-4">
                                            ...
                                            <input id="question" type="text" class="form-control" name="question" value="{{ $faq->question }}">
                                        ...
                                        <div class="col-sm-12 mt-4">
                                            ...
                                            <textarea id="answer" name="answer" class="form-control ckeditor" required>{{ $faq->answer }}</textarea>
                                        ...
                                        <div class="col-sm-6 mt-4">
                                            ...
                                            <input id="sequence" type="number" class="form-control" name="sequence" value="{{ $faq->sequence }}" style="width:30%">
                                        ...
                                        <div class="col-sm-6 mt-4">
                                            ...
                                            <select id="status" name="status" class="form-control">
                                                ...
                                                <option value="0" {{ $faq->status == 0 ? 'selected' : '' }}>Not Publish</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
