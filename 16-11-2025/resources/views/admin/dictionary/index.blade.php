                        ...
                        <form method="GET" action="{{ route('dictionary.index') }}">
                            <div class="row">
                                <div class="col-md-4 p-1">
                                    <input type="text" name="word" value="{{ request('word') }}" class="form-control" placeholder="Word: Type anyting...">
                                </div>
                                <div class="col-md-5 p-1">
                                    <input type="text" name="meaning" value="{{ request('meaning') }}" class="form-control" placeholder="Meaning:  Type anyting...">
                                </div>
                                <div class="col-md-3 p-1">
                                    <button type="submit" class="btn btn-primary btn-sm">Filter</button>
                                    <a href="{{ route('dictionary.index') }}" class="btn btn-secondary btn-sm">Reset</a>
                                </div>
                            </div>
