                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            ...
                            <a href="{{ route('services.create') }}" style="color:#fff; margin-right:20px" class="btn btn-primary btn-sm m-2"><i class="fa fa-plus"></i> Add New</a>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="tablerow{{ $service->id }}" class="tablerow">
                                            ...
                                            <td>{{ $service->icon }}</td>
                                            <td>
                                                <a href="{{ route('services.edit', $service->id) }}" class="btn btn-warning btn-sm me-2"><i class="fa fa-edit"></i></a>
                                                <a href="{{ route('services.show', $service->id) }}" class="btn btn-info btn-sm me-2"><i class="fa fa-eye"></i></a>
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    onclick="deleteSingle('{{ $service->id }}','masterdelete','services')"><i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
