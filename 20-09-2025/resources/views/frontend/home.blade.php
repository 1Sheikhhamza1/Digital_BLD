            ...
            <section id="about" class="about section">
                <div class="container">
                    <div class="row position-relative">
                        <div class="col-lg-6">
                            <h2 class="inner-title">What is BLD?</h2>
                            <p>
    ...
    <section id="services" class="services section light-background">
        <div class="container">
            <div class="row gy-4">
                ...
                $judgmentFormatted = preg_replace(
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-item item-cyan position-relative p-3 rounded shadow-sm">
                        <div class="icon mb-2">
                            <img src="{{ asset('frontend/assets/img/book.png') }}" alt="Case Icon" class="w-12 h-12">
                        </div>

                        <a href="{{ route('subscriber.login') }}" class="stretched-link text-decoration-none text-dark">
                            <!-- Party name (3 lines, lighter weight) -->
                            <div style="font-weight:bold; padding-bottom:5px">
                                {!! $decision->parties !!}
                            </div>

                            <!-- Case number (2 lines, normal text, not bold) -->
                            <div class="text-sm text-gray-500 mt-1 line-clamp-2" style="text-align:center;padding-bottom:5px">
                                {!! $decision->case_no !!}
                            </div>
                        </a>


                        <p class="text-sm text-gray-700 mt-2 line-clamp-4">{!! $judgmentFormatted !!}</p>
                    </div>
                </div>
