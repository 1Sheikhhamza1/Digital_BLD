        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="float-sm-end">
              ...
              <a href="{{ route('user_manual.create') }}" style="color:#fff; margin-right:20px" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Create New user_manual</a>
            </div>
          </div>
              ...
              <div class="card-body">
                <form id="form_check">
                  <table id="responsive-datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      @foreach($alluser_manual as $user_manual)
                      <tr id="tablerow{{ $user_manual->id }}" class="tablerow">
                        <td><input type="checkbox" name="summe_code[]" id="summe_code{{ $user_manual->id }}" value="{{ $user_manual->id }}" /></td>
                        <td>{{ $user_manual->topic }}</td>
                        <td>{{ $user_manual->question }}</td>
                        <td>{{ $user_manual->sequence }}</td>
                        <td>
                          @if($user_manual->status == 1)
                        ...
                        <td align="center">
                          <a href="{{ route('user_manual.edit', $user_manual->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
