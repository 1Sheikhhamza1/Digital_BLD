<footer id="footer" class="footer dark-background">
  ...
  <div class="container copyright text-center mt-4">
    <p>© 2025 <span>Copyright</span> <strong class="px-1 sitename">Bangladesh Legal Decisions</strong> <span>All Rights Reserved</span></p>
    <div class="credits">
      Designed & Developed by <a href="https://orbitasoft.com/" class="text-danger text-decoration-none">Orbita Soft</a>
    </div>
  </div>
