...
Route::prefix('subscriber')->group(function () {
    ...
    Route::name('subscriber.')->middleware(['auth:subscriber'])->group(function () {
        ...
        Route::middleware(['has.subscription'])->group(function () {
            ...
            Route::get('showResults', [LegalSearchController::class, 'showResults'])->name('showrResults');
            ...
            Route::get('myDecision/{id}/edit-note', [LegalDecesionUserNoteController::class, 'editDecisionNote'])->name('myDecision.editNote');
            ...
            Route::post('/files/download-multiple', [FileManagerController::class, 'downloadMultiple'])->name('files.downloadMultiple');
        });
        ...
        //// Additional Routes for Pending Task
        Route::get('legalTerminology', [DashboardController::class, 'legalTerminology'])->name('legalTerminology');
    });
});
