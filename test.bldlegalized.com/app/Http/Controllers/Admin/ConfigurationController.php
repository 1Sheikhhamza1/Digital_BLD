...
class ConfigurationController extends BaseController
{
    ...
    {
        /* $config = $this->service->get();
        $discoverMenu = Page::whereNull('parent_id')->where('page_structure', 'Text')->where('status', 1)->get();
        $quickMenu = Page::whereNull('parent_id')->where('page_structure', 'Page')->where('status', 1)->get(); */
