    ...
    <form method="POST" action="{{ route('subscriber.searchResult') }}">
        ...
        <div class="row g-3 form-group-row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <select class="select2Data form-select" id="selectFillingYear" name="published_year">
            ...
            <div class="col-md-4 mb-3">
                ...
                <select class="select2Data form-select" id="selectJudgmentYear" name="published_year">
