...
<div class="container mt-5">
  <div class="container document-container">
    ...
    <!-- <div class="document-section">
      <h6>Counsels:</h6>
      <p>
        <strong>The petitioners:</strong> {!! $data->petitioners ?? '' !!}
      </p>
      <p>
        <strong>The respondent:</strong> {!! $data->respondent ?? '' !!}
      </p>
    </div> -->
    ...
    <div class="print-footer">
      <table style="width:100%; font-size:11px; border-top:1px solid #eaeaea; border-collapse: collapse;">
        <tr>
          <td style="text-align:left; padding-top:10px; white-space: nowrap;">
            {{ now()->format('d M Y, h:i A') }}
          </td>
          <td style="text-align:center; padding-top:10px; white-space: nowrap;">
            <a href="https://bldlegalized.com" style="color: black;">&copy;bldlegalized.com</a>
          </td>
          <td style="text-align:right; padding-top:10px; white-space: nowrap;">
            {{ auth()->user()->name ?? 'Guest' }} | {{ auth()->user()->email ?? '-' }}
          </td>
        </tr>
      </table>
    </div>
