...
<style>
    ...
    .beta-disclaimer strong {
        color: #856404;
        /* dark amber for professional emphasis */
    }

    .beta-disclaimer:hover {
...
<div class="container py-4">
    <div class="row justify-content-center">
        ...
        <main class="col-lg-9 pe-4">
            ...
            <div class="beta-disclaimer shadow-sm rounded-3 p-3 d-flex align-items-center justify-content-between mb-4" style="background: linear-gradient(90deg, #fff3cd, #ffe69c); border-left: 6px solid #ffc107;">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-dark">This site and all its features are currently <strong>only for beta testing</strong>. Data and functionality may be incomplete or subject to change.</p>
                    </div>
                </div>
