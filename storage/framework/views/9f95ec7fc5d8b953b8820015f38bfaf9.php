    ...
    <main class="app-main">
        ...
        <div class="app-content">
            <div class="form-container col-sm-8 offset-2">
                ...
                <?php endif; ?>
                <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('configuration.update')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bldlegalized/public_html/resources/views/admin/configuration/edit.blade.php ENDPATH**/ ?>