...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <textarea name="description" class="form-control ckeditor <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                rows="4"><?php echo e(old('description', $service->description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-2">
                <img src="<?php echo e(asset('uploads/services/icon/' . $service->icon)); ?>" alt="Service Banner" style="max-height: 100px;">
            </div>
            <?php endif; ?>
        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-2">
                <img src="<?php echo e(asset('uploads/services/image/' . $service->image)); ?>" alt="Service Icon" style="max-height: 100px;">
            </div>
            <?php endif; ?>
        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(!empty($service->banner)): ?>
            <div class="mt-2">
                <img src="<?php echo e(asset('uploads/services/banner/' . $service->banner)); ?>" alt="Service Icon" style="max-height: 100px;">
            </div>
            <?php endif; ?>
        </div>
...
unset($__errorArgs, $__bag); ?>"
                value="<?php echo e(old('meta_title', $service->meta_title ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                rows="2"><?php echo e(old('meta_description', $service->meta_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <button type="submit" class="btn btn-primary"><?php echo e($buttonText ?? 'Save Service'); ?></button>
    </div>
</div><?php /**PATH /home/bldlegalized/public_html/resources/views/admin/services/_form.blade.php ENDPATH**/ ?>