...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="<?php echo e(route('subscriber.otp')); ?>" class="btnVerify">Verify Now</a>
            <p class="note">* Please do not share this code with anyone for security reasons.</p>
        </div>
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> Digital Bangladesh Legal Decisions. All rights reserved.
        </div>
    </div>
</body>
</html>
<?php /**PATH /home/bldlegalized/public_html/resources/views/emails/otp.blade.php ENDPATH**/ ?>