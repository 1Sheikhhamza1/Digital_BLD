...
<script>
    ...
    const eventsIndexUrl = "<?php echo e(route('subscriber.events.json')); ?>";
    const eventsStoreUrl = "<?php echo e(route('subscriber.events.store')); ?>";

    function getEventDestroyUrl(id) {
        return "<?php echo e(route('subscriber.events.destroy', ':id')); ?>".replace(':id', id);
    }
    /* function getEventUpdateUrl(id) {
      return "<?php echo e(route('subscriber.events.update', ':id')); ?>".replace(':id', id);
    } */
...
</script><?php /**PATH /Users/sheikhhamza/Desktop/Anti Gravatity/bldlegalized_bld/bldlegalized_bld/8122025public_html/public_html/resources/views/auth/subscribers/layouts/calender.blade.php ENDPATH**/ ?>