<?php $__env->startSection('title', 'Add New Volume'); ?>
    ...
    <main class="app-main">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('volumes.index')); ?>" class="btn btn-primary btn-sm">Volume List</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="app-content">
            <div class="form-container col-sm-8 offset-2">
                ...
                <!-- id="ocrForm" -->
                <form enctype="multipart/form-data" method="POST" action="<?php echo e(route('volumes.store')); ?>" id="ocrForm">
                    <?php echo csrf_field(); ?>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        setTimeout(function() {
                            ...
                            window.location.href = "<?php echo e(route('volumes.index')); ?>";
                        }, 2000);
                    },
                    error: function(xhr) {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bldlegalized/public_html/resources/views/admin/volumes/create.blade.php ENDPATH**/ ?>