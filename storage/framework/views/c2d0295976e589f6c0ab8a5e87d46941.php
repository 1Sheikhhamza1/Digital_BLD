        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="float-sm-end">
              ...
              <a href="<?php echo e(route('faq.create')); ?>" style="color:#fff; margin-right:20px" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Create New faq</a>
            </div>
          </div>
              ...
              <div class="card-body">
                <form id="form_check">
                  <table id="responsive-datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php $__currentLoopData = $allfaq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr id="tablerow<?php echo e($faq->id); ?>" class="tablerow">
                        <td><input type="checkbox" name="summe_code[]" id="summe_code<?php echo e($faq->id); ?>" value="<?php echo e($faq->id); ?>" /></td>
                        <td><?php echo e($faq->topic); ?></td>
                        <td><?php echo e($faq->question); ?></td>
                        <td><?php echo e($faq->sequence); ?></td>
                        <td>
                          <?php if($faq->status == 1): ?>
                        ...
                        <td align="center">
                          <a href="<?php echo e(route('faq.edit', $faq->id)); ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bldlegalized/public_html/resources/views/admin/faq/index.blade.php ENDPATH**/ ?>