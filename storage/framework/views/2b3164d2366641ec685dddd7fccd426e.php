...
<section class="service-sec service-v2-sec service-inner-sec section-padding gray-section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="login-box <?php echo e($transparent ? 'transparent-login' : 'solid-login'); ?>" style="max-width: 450px;">
                    ...
                    <form id="registrationForm" method="POST" action="<?php echo e(route('subscriber.otp.check')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bldlegalized/public_html/resources/views/auth/subscribers/forgot_password/otp.blade.php ENDPATH**/ ?>