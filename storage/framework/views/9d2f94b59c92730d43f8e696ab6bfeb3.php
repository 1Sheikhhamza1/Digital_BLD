...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="input-group mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <input id="date_of_birth" type="date" class="form-control" name="date_of_birth" value="<?php echo e(old('date_of_birth')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="input-group mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <input id="password" type="password" class="form-control" name="password" value="<?php echo e(old('password')); ?>" required>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bldlegalized/public_html/resources/views/admin/user/create.blade.php ENDPATH**/ ?>