    ...
    <script>
        ...
        function permissions(tables, status, statuscol) {
            ...
            if (dataval == "") {
                ...
                var urls = "<?php echo e(url('admin/permissions')); ?>";
        ...
        /* function showInHomepage(tables, status, statuscol) {
            var summeCode = document.getElementsByName("summe_code[]");
            var j = 0;
            var dataval = new Array();
        ...
        function deletedata(patch, tables) {
            ...
            if (dataval == "") {
                ...
                swal({
                    title: 'Are you sure?',
                    //type: 'warning',
                    imageUrl: "<?php echo e(asset('assets/images/favicons/favicon.png')); ?>",
...
</html><?php /**PATH /Users/sheikhhamza/Desktop/Anti Gravatity/bldlegalized_bld/bldlegalized_bld/8122025public_html/public_html/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>