        ...
        <?php $__empty_1 = true; $__currentLoopData = $highCourtDecisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $decision): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-4 d-flex">
                ...
                <a class="card-item d-flex flex-column h-100 w-100 p-3 border rounded shadow-sm text-decoration-none"
                   href="<?php echo e(route('subscriber.singleDecision', [$decision->id, Crypt::encrypt('legalDecisionHighCourt')])); ?>?page=<?php echo e(request()->get('page') ?? 1); ?>">
...
<?php echo $__env->make('auth.subscribers.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bldlegalized/public_html/resources/views/auth/subscribers/profile/highcourt.blade.php ENDPATH**/ ?>